  ...
  $watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))"
    ...
    <main>
      ...
      <section class="i pg ji gp uq">
        ...
        <img src="{{ Vite::asset('resources/images/shape-08.svg') }}"
          alt="Shape Bg" class="h q r" />
        <img src="{{ Vite::asset('resources/images/shape-09.svg') }}"
          alt="Shape" class="of h y z/2" />
        <img src="{{ Vite::asset('resources/images/shape-10.svg') }}"
          alt="Shape" class="h _ aa" />
        <img src="{{ Vite::asset('resources/images/shape-11.svg') }}"
          alt="Shape" class="of h m ba" />
            ...
            <div class="animate_top rj">
              <div class="c i pg z-1">
                ...
                <div class="ef im nl il">
                  <span
                    class="h -ud-left-5 -ud-bottom-21 rc de gd gh if wa"></span>
                  <span class="h s p rc vd hd mh va"></span>
                  <div class="h s p vd ij jj xa">
                    <ul class="tc xf wf gg">
                      <li>
                        <a href="#">
                          <svg class="uh vl ml il" width="10"
                      ...
                      <li>
                        <a href="#">
                          <svg class="uh vl ml il" width="18"
                      ...
                      <li>
                        <a href="#">
                          <svg class="uh vl ml il" width="17"
      ...
      <section x-data="setup()" class="i pg fh rm ji gp uq">
        <!-- Bg Shapes -->
        <img src="{{ Vite::asset('resources/images/shape-06.svg') }}"
          alt="Shape" class="h aa y" />
        <img src="{{ Vite::asset('resources/images/shape-03.svg') }}"
          alt="Shape" class="h ca u" />
        <img src="{{ Vite::asset('resources/images/shape-07.svg') }}"
          alt="Shape" class="h w da ee" />
        <img src="{{ Vite::asset('resources/images/shape-12.svg') }}"
          alt="Shape" class="h p s" />
        <img src="{{ Vite::asset('resources/images/shape-13.svg') }}"
          alt="Shape" class="h r q" />
            ...
            <template x-for="(plan, i) in plans" x-key="i">
              ...
              <div class="animate_top rj sg hh sm vk xm hi nj oj">
                ...
                <ul class="tc sf bg ob fb">
                  <template x-for="(feature, i) in plan.features"
                    x-key="i">
            ...
            <div class="animate_top mn/5 to/3 vk sg hh sm yh rq i pg w-full">
              ...
              <div>
                ...
                <ul class="tc wf fg">
                  ...
                  <li>
                    <a href="#" class="c tc wf xf ie ld rg ml il tl">
                      <svg class="th lm ml il" width="20" height="16"
                  ...
                  <li>
                    <a href="#" class="c tc wf xf ie ld rg ml il tl">
                      <svg class="th lm ml il" width="19" height="18"
                  ...
                  <li>
                    <a href="#" class="c tc wf xf ie ld rg ml il tl">
                      <svg class="th lm ml il" width="22" height="14"
      ...
      const setup = () => {
        return {
          ...
          plans: [{
              ...
              features: ['400 GB Storaget', 'Unlimited Photos & Videos',
                'Exclusive Support'
              ],
            },
            {
