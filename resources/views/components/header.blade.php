        ...
        <ul class="tc _o sf yo cg ep">
          <li>
            <x-nav-link href="{{ route('home') }}" :active="request()->routeIs('home')"
              href="{{ route('home') }}">Home</x-nav-link>
          </li>
          <li>
          ...
          <li>
            <x-nav-link :active="request()->routeIs('service')" href="{{ route('service') }}">Service
            </x-nav-link>
          </li>
          <li>
            <x-nav-link :active="request()->routeIs('contact')" href="{{ route('contact') }}">Contact
            </x-nav-link>
          </li>
        </ul>
      </nav>
        ...
        <div class="pc h io pa ra"
          ...
          <label class="rc ab i">
            <input type="checkbox" :value="darkMode"
              @change="darkMode = !darkMode" class="pf vd yc uk h r za ab" />
            <!-- Icon Sun -->
            <svg
              :class="{ 'wn': page === 'home', 'xh': page === 'home' && stickyMenu }"
              class="th om" width="25" height="25" viewBox="0 0 25 25"
            ...
            <!-- Icon Sun -->
            <img class="xc nm"
              src="{{ Vite::asset('resources/images/icon-moon.svg') }}"
              alt="Moon" />
          </label>
        </div>
      </div>
