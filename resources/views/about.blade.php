...
@section('content')
  <section class="i pg ji gp uq">
    ...
    <img src="{{ Vite::asset('resources/images/shape-08.svg') }}" alt="Shape Bg"
      class="h q r" />
    <img src="{{ Vite::asset('resources/images/shape-09.svg') }}" alt="Shape"
      class="of h y z/2" />
    <img src="{{ Vite::asset('resources/images/shape-10.svg') }}" alt="Shape"
      class="h _ aa" />
    <img src="{{ Vite::asset('resources/images/shape-11.svg') }}" alt="Shape"
      class="of h m ba" />
